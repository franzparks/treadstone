  ...
  function blogService() {
    var blogs = [
      ...
      },
      {
        ...
        'icon' : 'fa fa-file-text fa-4x',
        'text': 'This is a blog about the new series which is\
         under development but will use Ludlum\'s name.',
        'url':'http://placehold.it/600x300',
        'author' : 'Anonymous'
      },
      {
        'id' : '2',
        'date' : 'May 10, 2014',
        'title' : 'What is the Matarese Circle?',
        'icon' : 'fa fa-camera fa-4x',
