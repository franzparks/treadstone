...
(function(global) {
  ...
  global.toolbox.cache.name['my-cache'];
  global.toolbox.cache.maxEntries = 100;
  global.toolbox.cache.maxAgeSeconds = 86400;
  ...
  global.toolbox.router.get('/index.html', global.toolbox.cacheFirst, {
   ...
   global.toolbox.router.get('/sw.js', global.toolbox.cacheFirst, {
       cache: {
         name: 'my-cache'
       }
  ...
  global.toolbox.router.get(/^https:\/\/crossorigin.me\//
  , 
  ...
  global.toolbox.router.get(/^http:\/\/googleapis.com\//
  , 
  global.toolbox.cacheFirst, {
    cache: {
      name: 'my-cache'
...
var myDefaultRequestHandler = function() {
  return global.toolbox.router.get('/(.*)', 
    global.toolbox.cacheFirst, {
      cache: {
       name: 'my-cache'
     }
...
global.toolbox.router.default = myDefaultRequestHandler;
